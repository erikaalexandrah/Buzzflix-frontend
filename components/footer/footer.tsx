      ...
      <div className="max-w-6xl mx-auto px-6 py-12">
        <div className="flex flex-col md:flex-row md:items-start md:justify-between gap-10">
          ...
          <nav className="grid grid-cols-2 gap-x-12 gap-y-3 text-sm">
            ...
            <a href="/search" className="hover:text-white transition-colors">Explorar</a>
            <a href="/favorite" className="hover:text-white transition-colors">Favoritos</a>
        ...
        {/* Bottom bar */}
        <div className="mt-10 pt-6 border-t border-white/10 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-2 text-xs text-gray-500">
